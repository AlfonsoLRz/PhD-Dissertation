...
\newcommand{\dateDissertationSpanish}{junio de 2023}
...
\partIntro{II}{Materials and image fusion}{The first part of this chapter introduces the materials applied to this research work. Specifications and shortcomings of each device are illustrated and solved for the sake of clarity and to avoid its repeatability through this dissertation. Then, images are processed and matched to compose a multi-layer system that will help to construct enriched 3D models in later chapters. }
...
% \chapterBackground{figs/chapters/Chapter3_01.png}{figs/chapters/Chapter3_02.png}{Igor Tretyakov}{Low poly city}{Sketchfab}{black}
\chapterBackground{figs/chapters/Chapter7_01.png}{figs/chapters/Chapter7_02.png}{Alexander Ruz}{Combat robot}{Sketchfab}{black}
...
\chapterBackground{figs/chapters/Chapter4_01.png}{figs/chapters/Chapter4_02.png}{DailyArt}{Stone lion}{Sketchfab}{black}

\partIntro{IV}{Simulations and planning}{This part is split into three chapters. The first one simulates an efficient \acrshort{lidar} sensor aimed at providing large point cloud datasets for the training of Deep Learning models. Then, the \acrshort{lidar} data source is further enriched with intensity by taking into account the surface \acrshort{brdf}. Finally, the emulated sensor is applied to the optimization of \acrshort{lidar} scans within 3D buildings. }
...
\oddChapter
\chapterBackground{figs/chapters/Chapter5_01.png}{figs/chapters/Chapter5_02.png}{Georg Klein}{Viking ship}{Sketchfab}{white}
...
\oddChapter
\chapterBackground{figs/chapters/Chapter6_01.png}{figs/chapters/Chapter6_02.png}{Rigsters}{Deer group}{Sketchfab}{white}
...
\oddChapter
\chapterBackground{figs/chapters/Chapter8_01.png}{figs/chapters/Chapter8_02.png}{Mateusz Woliński}{Seraph}{Sketchfab}{black}
