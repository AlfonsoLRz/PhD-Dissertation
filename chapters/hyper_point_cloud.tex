...
\begin{marginfigure}[.cm]
	...
	\caption{Rendering of RGB (a, b) and green wavelength (c) point clouds with visualization optimizations (b, c) and naive compute shader approach (a).}
