...
\begin{figure*}[ht]
	...
	\caption{Overview of the proposed network architecture, with the input being concatenated to the output of a spatial-attention layer. Then, spectral and spatial features are extracted in Part II. Both Part III and IV comprise an Inception block with frequent follow-up layers. Finally, the resulting features are transformed to obtain the predicted label. }
